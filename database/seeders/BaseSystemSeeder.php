...
class BaseSystemSeeder extends Seeder
{
    ...
    {
        $this->command?->info('6️⃣  زرع الشروط والأحكام (نسخة 1.0 منشورة)...');

        $parentVersionId = DB::table('terms_versions')->insertGetId([
            'version_number' => '1.0',
            'title'          => 'شروط وأحكام تطبيق دربي لأولياء الأمور',
            'audience'       => 'parent',
            'status'         => 'published',
            'published_at'   => now(),
            'created_at'     => now(),
        ...
        $parentArticles = [
            'قبول الخدمة'          => 'باستخدامك لتطبيق دربي، فإنك تُقر بموافقتك على جميع الشروط والأحكام المذكورة في هذه الاتفاقية، وأي تعديلات مستقبلية يتم إشعارك بها عبر التطبيق.',
            'تسجيل الحساب'         => 'يلتزم ولي الأمر بتقديم بيانات صحيحة ومكتملة عند تسجيل الحساب، ويتحمل المسؤولية الكاملة عن سرية بيانات دخوله وأي نشاط يتم من خلال حسابه.',
            'بيانات الأبناء'       => 'يوافق ولي الأمر على تقديم البيانات الصحيحة والكاملة لأبنائه (الاسم، تاريخ الميلاد، الجنس، المدرسة، العنوان)، وتعهده بتحديثها فور أي تغيير.',
            'حجز الاشتراك'         => 'يُعتبر طلب الاشتراك ملزماً بعد قبول السائق له، ويُخصم مبلغ الاشتراك من محفظة ولي الأمر ويُحجز في الخزينة كضمان (Escrow) لصالح السائق حتى إتمام رحلات الفترة بنجاح.',
            'شحن المحفظة'          => 'يتم شحن المحفظة عبر وسائل الدفع المعتمدة (سداد / موبي كاش / مصرف الصحاري)، والمبلغ المشحون يُعتبر رصيداً للاستخدام داخل التطبيق ولا يُسترد نقداً.',
            'الغياب والاسترداد'    => 'في حال غياب الطفل ببلاغ مسبق قبل 24 ساعة عبر التطبيق، يُحتسب اليوم كغياب مبلَّغ ولا يُخصم من رصيد الاشتراك. الغياب دون بلاغ يُعتبر رحلة مكتملة.',
            'تعديل نقاط الوقوف'    => 'يحق لولي الأمر طلب تغيير نقطة الاستلام أو التسليم لرحلة معينة أو دائماً، مع تحمّل الرسوم المطبقة وفقاً لمسافة التغيير (5-15 د.ل حسب المدى).',
            'الإلغاء والاسترداد'   => 'في حال إلغاء الاشتراك قبل انتهاء مدته، يُحسب المتبقي بعد خصم قيمة الرحلات المنفذة ورسم إنهاء الاشتراك، ويُعاد الباقي إلى محفظة ولي الأمر.',
            'الشكاوى والتقييمات'   => 'يحق لولي الأمر تقديم شكوى أو تقييم للسائق عبر التطبيق، وتلتزم المنصة بالتحقيق فيها خلال 72 ساعة عمل واتخاذ الإجراءات المناسبة.',
            'حماية الخصوصية'       => 'تلتزم منصة دربي بحماية بيانات ولي الأمر وأبنائه ولا تُشارك أي بيانات مع أطراف خارجية إلا بإذن صريح أو بأمر قضائي.',
            'المسؤولية والضمانات'   => 'المنصة وسيط تقني وحيد بين ولي الأمر والسائق، ولا تتحمل المسؤولية عن أي اتفاقيات جانبية أو التزامات خارج نطاق التطبيق.',
            'التعديل على الشروط'   => 'يحق للمنصة تعديل هذه الشروط في أي وقت مع إشعار المستخدم عبر التطبيق قبل 15 يوماً من نفاذ التعديل، ويُعتبر استمرار الاستخدام قبولاً للتعديلات.',
        ];

        $sort = 0;
        foreach ($parentArticles as $title => $body) {
            $sort++;
        ...
        $driverVersionId = DB::table('terms_versions')->insertGetId([
            'version_number' => '1.0',
            'title'          => 'شروط وأحكام تطبيق دربي للسائقين',
            'audience'       => 'driver',
            'status'         => 'published',
            'published_at'   => now(),
            'created_at'     => now(),
        ...
        $driverArticles = [
            'قبول الخدمة'          => 'باستخدامك لتطبيق دربي كسائق، فإنك تُقر بموافقتك على جميع الشروط المذكورة في هذه الاتفاقية، بما فيها معايير السلامة والسلوك المهني.',
            'التحقق من الهوية'     => 'يلتزم السائق بتقديم مستنداته الأصلية (البطاقة الشخصية، رخصة القيادة، الدفتر، التأمين، الطابع الجمركي، الفحص الفني) وتخضع للمراجعة والاعتماد من الإدارة.',
            'التزامات السائق'      => 'يلتزم السائق بالحضور في المواعيد المتفق عليها، مراعاة معايير السلامة المرورية، تشغيل التكييف، والتعامل الأخلاقي مع الطلاب.',
            'المحفظة والعمولة'     => 'تقتطع المنصة عمولة 8% من إجمالي قيمة كل اشتراك، ويُودع المبلغ المتبقي في محفظة السائق بعد إتمام كل رحلة بنجاح.',
            'طلبات السحب'          => 'يحق للسائق طلب سحب رصيد محفظته في أي وقت، وتُعالج طلبات السحب خلال 24-48 ساعة عمل عبر إحدى وسائل الدفع المعتمدة.',
            'الغياب والإشعار'      => 'يلتزم السائق بالإبلاغ عن أي غياب طارئ قبل 12 ساعة على الأقل عبر التطبيق، وأي غياب دون إشعار يستوجب غرامة تعادل قيمة رحلات اليوم.',
            'الأعطال الطارئة'      => 'في حال عطل المركبة أثناء الرحلة، يُلزم السائق بالضغط على زر الطوارئ SOS في التطبيق فوراً لتفعيل بروتوكول النقل البديل.',
            'حظر الركاب الغرباء'    => 'يُحظر تماماً السماح لأي شخص غير مسجل في المسار بالصعود إلى المركبة أثناء نقل الطلاب، وأي مخالفة تستوجب إيقاف الحساب فوراً.',
            'التقييمات والشكاوى'    => 'يخضع السائق للتقييم المستمر من أولياء الأمور، وأي تقييم متدنٍ متكرر أو شكوى مثبتة تستوجب اتخاذ إجراءات تصحيحية أو إيقاف الحساب.',
            'إنهاء الحساب'         => 'يحق للمنصة إنهاء أو تجميد حساب السائق فوراً عند ثبوت أي مخالفة تتعلق بسلامة الطلاب أو تكرار الشكاوى الجوهرية.',
            'حماية البيانات'       => 'يتعهد السائق بالحفاظ على خصوصية بيانات الأطفال وأولياء أمورهم وعدم إفشائها لأي طرف خارج نطاق التطبيق.',
            'التعديل على الشروط'   => 'يحق للمنصة تعديل هذه الشروط في أي وقت مع إشعار السائق قبل 15 يوماً من نفاذ التعديل.',
        ];

        $sort = 0;
        foreach ($driverArticles as $title => $body) {
            $sort++;
            DB::table('terms_articles')->insert([
        ...
        $this->command?->line('   ✔ نسختان منشورتان: parent (12 مادة) + driver (12 مادة)');
    }
